...
export function StudentListPage(props: StudentListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStudents({
        relations: ['user', 'feedback.count', 'lesson.count', 'task.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['name.contains', 'learning_style.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'learning_style', header: 'Learning Style', accessorKey: 'learning_style' },
    { id: 'progress_level', header: 'progress_level', accessorKey: 'progress_level' },

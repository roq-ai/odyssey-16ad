    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <TextInput
            error={formik.errors.learning_style}
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'progress_level',
              isInvalid: !!formik.errors?.progress_level,
            }}
            name="progress_level"
            error={formik.errors?.progress_level}
            value={formik.values?.progress_level}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('progress_level', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />

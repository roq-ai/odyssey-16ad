  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Embark on a learning journey with Odyssey - the AI homeschooling app that adapts, grows, and personalizes each student's experience, inspiring progress and delivering insightful feedback."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1585432959445-662c9bbcd91d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxob21lc2Nob29saW5nfGVufDB8fHx8MTY5NDUxNTIzOHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Embark on a learning journey with Odyssey - the AI homeschooling app that adapts, grows, and personalizes each student's experience, inspiring progress and delivering insightful feedback.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Guardian User" type="guardian-user" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
